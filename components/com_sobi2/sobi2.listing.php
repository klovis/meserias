<?php
/**
* @version $Id: sobi2.listing.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
...
class sobiListings {
    ...
    function showMyListing()
    {
		...
		echo HTML_SOBI::buildCustomListing(
					...
					null,												/* $catsOrdering 			*/
					null,												/* $pluginsArgs 			*/
					$checkunpublished									/* $forceUnpublishedItems 	*/
		);
    }
	 /**
     ...
     */
     function showAlphaListing( $letter )
     {
		...
		$cids = null;
		$browsertitel = _SOBI2_ALPHA_ITEMS_WITH_LETTER;
		if ($config->key("alpha_index", "show_categories", 1)) {
			$browsertitel = _SOBI2_ALPHA_LETTER;
		...
		echo HTML_SOBI::buildCustomListing(
							...
							_SOBI2_ALPHA_HEADER." \"{$phrase}\"",					/* $addToPathway	*/
							$browsertitel." \"{$phrase}\"",							/* $addToSiteTitle 	*/
							0,														/* $defCid 			*/
    ...
    function showListingByTag( $tag )
    {
		...
		echo HTML_SOBI::buildCustomListing(
							...
							null,												/* $stringForItems 	*/
							null,												/* $stringForCats 	*/
							_SOBI2_TAGGED_HEADER." \"{$tag}\"",					/* $addToPathway	*/
