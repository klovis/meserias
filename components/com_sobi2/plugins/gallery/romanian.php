...
DEFINE("_S_2_GALLERY_UPLOAD_BUTTON", "Incarca imagine");			//Adjust to fit your needs
DEFINE("_S_2_GALLERY_UPDATE_BUTTON", "Modifica imagine");			//Adjust to fit your needs

DEFINE("_S_2_GALLERY_EDIT_DETAILS_BUTTON", "Modifica detalii imagine");			//Adjust to fit your needs
DEFINE("_S_2_GALLERY_EDIT_FILENAME_LBL", "Nume fisier");	//Adjust to fit your needs
DEFINE("_S_2_GALLERY_EDIT_WARNING", "Salveaza acest formular inainte de a salva anuntul cu meseriasul altfel Imaginile nu vor fi salvate!");	//Adjust to fit your needs
DEFINE("_S_2_GALLERY_EDIT_TITLE_LBL", "Descriere imagine");			//Adjust to fit your needs
DEFINE("_S_2_GALLERY_EDIT_ALTTEXT_LBL", "Text alternativ");	//Adjust to fit your needs
DEFINE("_S_2_GALLERY_EDIT_POSITION_LBL", "Pozitia");	//Adjust to fit your needs
DEFINE("_S_2_GALLERY_EDIT_UPDATE_BUTTON", "Modifica");	//Adjust to fit your needs


/* RC2.2 */
/* --------------------------------- */
DEFINE("_S_2_GALLERY_NOIMAGES", "Nici o imagine nu este disponibila");		//Adjust to fit your needs
...
/* RC2.0 */
/* --------------------------------- */
DEFINE('_S_2_GALLERY_TITLE', 'Portofoliu lucrari </br> in imagini');
DEFINE("_SGADM_GEN_POS", "IFrame Position");

/* Beta 4 */
/* --------------------------------- */
DEFINE('_S_2_GALLERY_DELETE_FILE', 'Sterge aceasta imagine');
DEFINE('_S_2_GALLERY_IMAGE_TITLE', 'Descriere imagine: ');
DEFINE('_S_2_GALLERY_IMAGES', 'Imagini: ');
DEFINE('_S_2_GALLERY_ADD_IMAGE', '<strong>Adauga o noua imagine:</strong>');
DEFINE('_S_2_GALLERY_ERR_RESAMPLING', 'Eroare la resampling imagine');
DEFINE('_S_2_GALLERY_ERR_COPY', 'Eroare la copierea imaginii');
DEFINE('_S_2_GALLERY_ERR_MOVE', 'Eroare la mutarea imaginii');
DEFINE('_S_2_GALLERY_ERR_FILESIZE', 'Marimea imaginii incarcate este prea mare');
DEFINE('_S_2_GALLERY_ERR_EXT', 'Imaginea incarcata nu are o extensie permisa pe acest site. Va rugam, incarcati o imagine cu o alta extensie.');
