...
DEFINE('_S_2_REV_AUTHOR', 'Author: ');
DEFINE('_S_2_REV_DATE', 'Date: ');
DEFINE('_S_2_REV_SEND_BT', 'Send');
DEFINE('_S_2_REV_RATE_NOW', 'Rate now: ');
DEFINE('_S_2_REV_WRITE_REV', 'Write Review');
DEFINE('_S_2_REV_AUTHOR_NAME', 'Name: ');
DEFINE('_S_2_REV_TEXT', 'Text: ');
DEFINE('_S_2_REV_TITLE', 'Title: ');
DEFINE('_S_2_REV_EMAIL', 'Email: ');
DEFINE('_S_2_REV_EMAIL_SHOW', 'Show my email ');
DEFINE('_S_2_REV_THNX_VOTE', 'Thank you for your vote.');
DEFINE('_S_2_REV_THNX_REV', 'Thank you for your review.');
DEFINE('_S_2_REV_NO_AUTOPUBLISH', 'Your review has to be approved before publishing.');
DEFINE('_S_2_REV_ENTRY_UPDATED', 'The Entry has been updated in the meantime!');
DEFINE('_S_2_REV_ERR_SAVING', 'Error saving data. Please try again.');
DEFINE('_S_2_REV_REVIEWS_LISTING', 'Reviews: ');
DEFINE('_S_2_REV_VOTE_SELECT', 'Select');
