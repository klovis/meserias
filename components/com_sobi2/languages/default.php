<?php
/**
* @version $Id: default.php 5462 2010-08-18 08:25:37Z Sigrid Suski $
 ...
 * added (RC 2.9.2.4)
 */
defined('_SOBI2_NEVER') or define('_SOBI2_NEVER', 'Never');

/*
 * added (RC 2.9.2)
 */
defined('_SOBI2_NOENTRYINCAT') or define('_SOBI2_NOENTRYINCAT', 'No entries in this category.');
...
defined('_SOBI2_NOT_LOGGED_FOR_DETAILS') or define('_SOBI2_NOT_LOGGED_FOR_DETAILS', 'You have to be a registered user and logged in to see this resource');
defined('_SOBI2_JS_NOT_LOGGED_FOR_DETAILS') or define('_SOBI2_JS_NOT_LOGGED_FOR_DETAILS', 'You have to be a registered user and logged in to see this resource');
 ...
 * Payment Class
 */
defined('_SOBI2_PAY_CHOSEN_OPTIONS') or define('_SOBI2_PAY_CHOSEN_OPTIONS', 'You have chosen the following paid options');
