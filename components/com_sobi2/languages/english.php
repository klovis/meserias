 ...
 * added (RC 2.9.2.4)
 */
define('_SOBI2_NEVER', 'Never');

/*
 * added (RC 2.9.2)
 */
define('_SOBI2_NOENTRYINCAT', 'No entries in this category.');
...
DEFINE('_SOBI2_NOT_LOGGED_FOR_DETAILS', 'You have to be a registered user and logged in to see this resource');
DEFINE('_SOBI2_JS_NOT_LOGGED_FOR_DETAILS', 'You have to be a registered user and logged in to see this resource');
 ...
 * Payment Class
 */
DEFINE('_SOBI2_PAY_CHOSEN_OPTIONS', 'You have chosen the following paid options');
